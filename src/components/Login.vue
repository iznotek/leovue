<template id="login-form" >
  <div class="login-wrapper">
    <div class="login-left">
      <img height="200" src="static/arkom/romanesco.png">
    </div>
    <form class="login-right" @submit.prevent>
      ...
      <div class="checkbox-container">
        <input type="checkbox" v-if="rememberMe">
...
export default {
  ...
  methods: {
    ...
    login () {
      ...
      if (this.username === 'bob' && this.password === 'dylan') {
        ...
        this.$store.state.user = {name: this.username, pw: this.password}
      }
    },
    register () {
      alert('Coming soon ...')
