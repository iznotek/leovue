<template>
  ...
  <div class="behind" 
      ...
      <comment-grid :baseURL="baseURL"
                  ...
                  :userNameColor="unc" 
                  :initialMessageLimit="iniMesLim.toString()" 
                  :maxUserNameLength="maxUserLen.toString()" 
                  :maxCommentLength="maxCommentLen.toString()" 
                  :maxShowingDepth="maxShowDep.toString()" 
                  :maxLineLimit="maxLineLim.toString()" 
                  v-on:close-picker="clearPickers" 
                  :custom="true" 
                  v-on:loading-finished="loadingFinish">
      </comment-grid> 
  ...
  export default {
    ...
    watch: {
      ...
      maxCommentLen (newValue, oldValue) {
        this.maxCommentLen = this.maxCommentLen < 1 ? 1 : this.maxCommentLen
      },
      iniMesLim (newValue, oldValue) {
        this.iniMesLim = this.iniMesLim < 1 ? 1 : this.iniMesLim
      },
      maxLineLim (newValue, oldValue) {
        this.maxLineLim = this.maxLineLim < 1 ? 1 : this.maxLineLim
      },
      maxShowDep (newValue, oldValue) {
        this.maxShowDep = this.maxShowDep < 1 ? 1 : this.maxShowDep
      }
    },
    components: {
