<template>
    <div>
        <div class="bm-burger-button" @click="openMenu" style="margin-top: 30px; margin-left: 200px;" :class="{ hidden: !burgerIcon }">
        ...
        <div id="sideNav" class="bm-menu">
            ...
            <span class="bm-cross-button cross-style" @click="closeMenu" style="top: 40px;" :class="{ hidden: !crossIcon }">
